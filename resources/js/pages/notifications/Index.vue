        ...
        <div class="app-toolbar py-3 py-lg-6">
            <div class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <router-link to="/panel/notifications/add" class="btn btn-sm fw-bold btn-primary">
                        Tambah Data
                    </router-link>
                </div>
            </div>
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer">
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        ...
                                        <tr v-for="(data, d) in response.data_content.data">
                                            ...
                                            <td>
                                                <div>{{ $filter.formatDateTime(data.created_at) }}</div>
                                            </td>
                                            <td class="text-end">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <!-- <router-link :to="'/panel/notifications/' + data.id"
                                                            class="dropdown-item">
                                                            Edit
                                                        </router-link> -->
...
export default {
    ...
    setup() {
        const title = "Data Notifikasi"
        const breadcrumb_list = ["Notifikasi", "Data"];
