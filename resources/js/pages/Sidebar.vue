            ...
            <router-link to="/panel/dashboard">
                <div class="app-sidebar-logo-default">
                    <div class="d-flex align-items-center">
                        <img alt="Logo" src="/assets/photos/rocket_arena.png" class="h-35px app-sidebar-logo-default">
                        <div class="text-white fw-bold ms-3 text-lg">
                            <span class="text-white">Rocket</span> <span class="text-danger">Arena</span>
                        </div>
                    </div>
                </div>
                <img alt="Logo" src="/assets/photos/rocket_arena.png" class="h-20px app-sidebar-logo-minimize">
            </router-link>
